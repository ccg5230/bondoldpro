...
public class BondInstIndu extends BaseModel implements Serializable {
	...
	public String getFatClassName() {
		return fatClassName;
	}

	public void setFatClassName(String fatClassName) {
		this.fatClassName = fatClassName;
	}
