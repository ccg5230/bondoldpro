...
//	}
	 ...
	 * @return
	 */
	public List<BondComExtVo> findNotInit(){
		String sql = "SELECT com_chi_name,com_uni_code,ama_com_id ,ama_com_name, indu_uni_code,indu_uni_name_l4  FROM " + databaseNameConfig.getDmdb() + ".t_bond_com_ext where indu_uni_code_l4 <  indu_uni_code OR indu_uni_code_l4 =  indu_uni_code";
		return jdbcTemplate.query(sql, new BeanPropertyRowMapper<BondComExtVo>(BondComExtVo.class));
	}
	 ...
	 * @return
	 */
	public int updateInduCode4(Long induCode4, Long comUniCode){
		String sql = "UPDATE " + databaseNameConfig.getDmdb() + ".t_bond_com_ext SET indu_uni_code_l4 = ? WHERE com_uni_code = ?";
		return jdbcTemplate.update(sql, induCode4, comUniCode);
	}
