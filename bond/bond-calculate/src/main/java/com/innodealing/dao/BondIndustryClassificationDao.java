...
public class BondIndustryClassificationDao {
     ...
     * @return
     */
    public Long findInduCodeByFourName(String fourthName){
    	String sql = "SELECT industry_code FROM dmdb.t_bond_industry_classification WHERE fourth_name = '"+ fourthName +"' ORDER BY industry_code DESC LIMIT 1";
    	log.info("sql -> " + sql);
