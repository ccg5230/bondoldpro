...
public class Constants {
	...
	public static final List<Integer> VALID_DEALED_STATUS = Arrays.asList(1, 2);

	public static final List<Integer> PUBLIC_SOURCE = Arrays.asList(1, 2, 3);

	public static final List<Integer> PRIVATE_SOURCE = Arrays.asList(0, 4);
	...
	//卡片消息
	public static final String MESSAGETYPE_CARDMSG = "bond_portfolio_card";
	//通知消息
	public static final String MESSAGETYPE_NOTIFICATIONMSG = "bond_portfolio_notification";
	// 投组修改
	public static final String MESSAGETYPE_PORTFOLIO_GROUP_UPDATE = "bond_portfolio_group_update";
	// 投组添加
	public static final String MESSAGETYPE_PORTFOLIO_GROUP_ADD = "bond_portfolio_group_add";
}
