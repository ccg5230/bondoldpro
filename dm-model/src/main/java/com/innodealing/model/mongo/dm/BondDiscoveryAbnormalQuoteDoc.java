...
@Document(collection = "bond_discovery_abnormal_quote")
public class BondDiscoveryAbnormalQuoteDoc extends BondInstDoc implements Serializable {
	private static final long serialVersionUID = 1L;

	@ApiModelProperty(value = "异常报价方向:1-报价收券-bid;2-报价出券-ofr")
	private Integer side;

	@Indexed
	@ApiModelProperty(value = "报价的公布时间")
	...
	@ApiModelProperty(value = "买入报价Bid净价")
	private Double bidNetPrice;

	@ApiModelProperty(value = "买入报价Bid收益率")
	private Double bidPriceYield;

	@ApiModelProperty(value = "卖出报价Ofr净价")
	private Double ofrNetPrice;

	@ApiModelProperty(value = "卖出报价Ofr收益率")
	private Double ofrPriceYield;
	...
	public Double getBidNetPrice() {
		return bidNetPrice;
	}

	public void setBidNetPrice(Double bidNetPrice) {
		this.bidNetPrice = bidNetPrice;
	}

	public Double getOfrNetPrice() {
		return ofrNetPrice;
	}

	public void setOfrNetPrice(Double ofrNetPrice) {
		this.ofrNetPrice = ofrNetPrice;
	}
	...
	public Double getBidPriceYield() {
		return bidPriceYield;
	}

	public void setBidPriceYield(Double bidPriceYield) {
		this.bidPriceYield = bidPriceYield;
	}

	public Double getOfrPriceYield() {
		return ofrPriceYield;
	}

	public void setOfrPriceYield(Double ofrPriceYield) {
		this.ofrPriceYield = ofrPriceYield;
	}
