...
public class BondDmFilterDoc implements Serializable {

	@Id
	@Indexed
	@ApiModelProperty(value = "方案编号, 添加方案时不要填")
	...
	@ApiModelProperty(value = "债项评级, 列表元素并列关系，取值范围1~6,99, 含义参考dmdb.t_pub_par(PAR_SYS_CODE:2008)")
	...
	@ApiModelProperty(value = "是否在回收站", hidden = true)
	private Boolean isInTrash;

	@ApiModelProperty(value = "行业分类, 1: GICS, 2: 申万")
	...
	public String toString() {
		return "BondDmFilterDoc [" + (filterId != null ? "filterId=" + filterId + ", " : "")
				+ (filterName != null ? "filterName=" + filterName + ", " : "")
				+ (userId != null ? "userId=" + userId + ", " : "")
				+ (createTime != null ? "createTime=" + createTime + ", " : "")
				+ (updateTime != null ? "updateTime=" + updateTime + ", " : "")
				+ (pds != null ? "pds=" + pds + ", " : "") + (tenors != null ? "tenors=" + tenors + ", " : "")
				+ (dmBondTypes != null ? "dmBondTypes=" + dmBondTypes + ", " : "")
				+ (induIds != null ? "induIds=" + induIds + ", " : "")
				+ (issuer != null ? "issuer=" + issuer + ", " : "")
				+ (regions != null ? "regions=" + regions + ", " : "")
				+ (ownerTypes != null ? "ownerTypes=" + ownerTypes + ", " : "")
				+ (bondRatings != null ? "bondRatings=" + bondRatings + ", " : "")
				+ (issRatings != null ? "issRatings=" + issRatings + ", " : "")
				+ (markets != null ? "markets=" + markets + ", " : "")
				+ (munInvest != null ? "munInvest=" + munInvest + ", " : "")
				+ (isValidQuoteExist != null ? "isValidQuoteExist=" + isValidQuoteExist + ", " : "")
				+ (isInTrash != null ? "isInTrash=" + isInTrash : "") + "]";
	}
