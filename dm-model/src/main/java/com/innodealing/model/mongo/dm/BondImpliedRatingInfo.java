...
@Document(collection = "bond_implied_rating_info")
public class BondImpliedRatingInfo implements Serializable {
	...
	public BondImpliedRatingInfo() {
		super();
		// TODO Auto-generated constructor stub
	}

	public BondImpliedRatingInfo(String id, BigInteger level, String rating, Integer priority, Boolean isParent,
			String name) {
		super();
		this.id = id;
		this.level = level;
