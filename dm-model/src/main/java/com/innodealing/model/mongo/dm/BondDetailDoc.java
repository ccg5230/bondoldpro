...
public class BondDetailDoc extends BondInstDoc implements Serializable {
	...
	@ApiModelProperty(value = "best bid price")
	private BigDecimal bestBidPrice;

	@ApiModelProperty(value = "best offer price")
	private BigDecimal bestOfrPrice;
	...
	private List<Map<String, Object>> quarters;
	...
	@ApiModelProperty(value = "bid最后成交日期")
	@JsonFormat(pattern = "yyyy/MM/dd HH:mm:ss")
	private Date bidUpdateTime;
	
	@ApiModelProperty(value = "ofr最后成交日期")
	@JsonFormat(pattern = "yyyy/MM/dd HH:mm:ss")
	private Date ofrUpdateTime;
	...
	public String toString() {
		return "BondDetailDoc [" + (bondUniCode != null ? "bondUniCode=" + bondUniCode + ", " : "")
				+ (name != null ? "name=" + name + ", " : "") + (code != null ? "code=" + code + ", " : "")
				+ (ofrPrice != null ? "ofrPrice=" + ofrPrice + ", " : "")
				+ (ofrVol != null ? "ofrVol=" + ofrVol + ", " : "")
				+ (ofrOrderCnt != null ? "ofrOrderCnt=" + ofrOrderCnt + ", " : "")
				+ (bidPrice != null ? "bidPrice=" + bidPrice + ", " : "")
				+ (bidVol != null ? "bidVol=" + bidVol + ", " : "")
				+ (bidOrderCnt != null ? "bidOrderCnt=" + bidOrderCnt + ", " : "")
				+ (price != null ? "price=" + price + ", " : "")
				+ (coupRate != null ? "coupRate=" + coupRate + ", " : "")
				+ (pdDiff != null ? "pdDiff=" + pdDiff + ", " : "")
				+ (poPositive != null ? "poPositive=" + poPositive + ", " : "")
				+ (poNeutral != null ? "poNeutral=" + poNeutral + ", " : "")
				+ (poNegtive != null ? "poNegtive=" + poNegtive + ", " : "")
				+ (updateTime != null ? "updateTime=" + updateTime + ", " : "")
				+ (createTime != null ? "createTime=" + createTime + ", " : "")
				+ (tenor != null ? "tenor=" + tenor + ", " : "") + (pd != null ? "pd=" + pd + ", " : "")
				+ (pdTime != null ? "pdTime=" + pdTime + ", " : "")
				+ (issBondRating != null ? "issBondRating=" + issBondRating + ", " : "")
				+ (issRating != null ? "issRating=" + issRating + ", " : "")
				+ (bondRating != null ? "bondRating=" + bondRating + ", " : "")
				+ (isFavorited != null ? "isFavorited=" + isFavorited + ", " : "")
				+ (favoriteId != null ? "favoriteId=" + favoriteId + ", " : "")
				+ (isCompared != null ? "isCompared=" + isCompared + ", " : "")
				+ (pdUiOpt != null ? "pdUiOpt=" + pdUiOpt + ", " : "")
				+ (issRatingUiOpt != null ? "issRatingUiOpt=" + issRatingUiOpt + ", " : "")
				+ (bondRatingUiOpt != null ? "bondRatingUiOpt=" + bondRatingUiOpt + ", " : "")
				+ (tenorUiOpt != null ? "tenorUiOpt=" + tenorUiOpt + ", " : "")
				...
				+ (pledgeCode != null ? "pledgeCode=" + pledgeCode + ", " : "")
				+ (isCrossMar != null ? "isCrossMar=" + isCrossMar + ", " : "")
				...
				+ (bestBidPrice != null ? "bestBidPrice=" + bestBidPrice + ", " : "")
				+ (bestOfrPrice != null ? "bestOfrPrice=" + bestOfrPrice + ", " : "")
	...
	/**
	 * @return the bestOfrPrice
	 */
	public BigDecimal getBestOfrPrice() {
		return bestOfrPrice;
	}

	/**
	 * @param bestOfrPrice
	 *            the bestOfrPrice to set
	 */
	public void setBestOfrPrice(BigDecimal bestOfrPrice) {
		this.bestOfrPrice = bestOfrPrice;
	}
	...
	public void setQuarters(List<Map<String, Object>> quarters) {
	...
	public Date getBidUpdateTime() {
		return bidUpdateTime;
	}

	public void setBidUpdateTime(Date bidUpdateTime) {
		this.bidUpdateTime = bidUpdateTime;
	}

	public Date getOfrUpdateTime() {
		return ofrUpdateTime;
	}

	public void setOfrUpdateTime(Date ofrUpdateTime) {
		this.ofrUpdateTime = ofrUpdateTime;
	}
