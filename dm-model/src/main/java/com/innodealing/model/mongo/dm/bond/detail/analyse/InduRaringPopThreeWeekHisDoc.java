 ...
 * 
 * @author zhaozhenglai
 * @since 2016年9月14日 下午5:13:44 
 * Copyright © 2016 DealingMatrix.cn. All Rights Reserved.
 */
@Document(collection = "indu_raringpop_three_week_his")
public class InduRaringPopThreeWeekHisDoc implements Serializable{
    ...
    public InduRaringPopThreeWeekHisDoc(Long induId, Long issId, String issName, int thisWeekR, int lastWeekR,
            int beforeLastWeekR, int thisWeekP, int lastWeekP, int beforeLastWeekP) {
        super();
        this.induId = induId;
        this.issId = issId;
        this.issName = issName;
    ...
    public InduRaringPopThreeWeekHisDoc() {
        super();
    }
