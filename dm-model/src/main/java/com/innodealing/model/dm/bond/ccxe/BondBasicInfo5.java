...
@Entity
@Table(name="d_bond_basic_info_5")
public class BondBasicInfo5 implements Serializable{
     ...
     * 
     */
    @Column(name="BOND_SHORT_NAME", length=201)
     ...
     * 
     */
    @Column(name="IS_TYPE_PAR", length=22)
    private Double isTypePar;
     ...
     * 
     */
    @Column(name="CURR_STATUS", length=22)
    ...
    public void setIsTypePar(Double isTypePar){
       this.isTypePar = isTypePar;
    }
    
    public Double getIsTypePar(){
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        BondBasicInfo5 other = (BondBasicInfo5) obj;
        if (actuEndDate == null) {
