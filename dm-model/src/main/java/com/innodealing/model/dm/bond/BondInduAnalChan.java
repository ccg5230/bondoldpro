...
@Entity
@Table(name="t_bond_indu_anal_chan")
public class BondInduAnalChan implements Serializable{
	/**
     * 
     */
    private static final long serialVersionUID = 7265052635131605792L;
	...
	/**
	 * @param induCategoryId the induCategoryId to set
	 */
    public void setInduCategoryId(Long induCategoryId){
       this.induCategoryId = induCategoryId;
    }
    
    /**
     * @return the induCategoryId 
     */
    public Long getInduCategoryId(){
       return this.induCategoryId;
    }
