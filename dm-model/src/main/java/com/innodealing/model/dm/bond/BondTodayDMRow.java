...
public class BondTodayDMRow {
    @ApiModelProperty(value="是否根节点")
    private Boolean isRoot;

    @ApiModelProperty(value="子集列表")
    private List<BondTodayDMRow> subRowList;
    ...
    public List<BondTodayDMRow> getSubRowList() {
        return subRowList;
    }

    public void setSubRowList(List<BondTodayDMRow> subRowList) {
        this.subRowList = subRowList;
    }
