...
public class SafeUtils {
	...
	public static final String DATE_TIME_FORMAT4 = "MM/dd HH:mm";
	public static final String DATE_TIME_FORMAT5 = "yyyy/MM/dd HH:mm";
	...
	public static java.util.Date getCurrentDate() {
        String currentDate = getCurrDateFmtStr();
        java.util.Date tmpnow = parseDate(currentDate,DATE_FORMAT);
        return tmpnow;
    }
...
//        list = tep;
    ...
    */
	...
	public static Date getDateFromSpecifiedDateStr(String DateStr, int days, String format) {
		Date result = null;
		try {
			Calendar cld = Calendar.getInstance();
			...
			log.error(String.format("getDateFromDateStr: days[%1$d] exception[%2&s]", days, ex.getMessage()));
		}
		return result;
	}
	
	public static String getDateFromNowInYear(int intervalYear) {
		String result = null;
		try {
			Calendar cld = Calendar.getInstance();
			SimpleDateFormat sdf = new SimpleDateFormat(DATE_FORMAT);
			cld.add(Calendar.YEAR, intervalYear);
			result = sdf.format(cld.getTime());
		} catch (Exception ex) {
			log.error(String.format("getDateFromNowInYear: year[%1$d] exception[%2&s]", intervalYear, ex.getMessage()));
		}
		return result;
	}
