 ...
 * @author xiaochao
 * @date 2017年9月12日
 * @clasename BondFavoritePriceIndexDAO.java
 * @decription TODO
 */
@Component
public class BondFavoritePriceIndexDAO {

	public final static Logger logger = LoggerFactory.getLogger(BondFavoritePriceIndexDAO.class);
	...
	public int batchDeleteByFavIdList(List<Integer> favIdList) {
		...
		String sql = "DELETE FROM t_bond_favorite_price_index WHERE favorite_id IN (%1$s);";
	...
	public int batchDeleteByGroupIdList(List<Integer> groupIdList) {
		...
		String sql = "DELETE FROM t_bond_favorite_price_index WHERE group_id IN (%1$s);";
