package com.innodealing.engine.redis;
...
public class RedisUtil {
	...
	public boolean incr(final String key, long cnt) {
		boolean result = false;
		try {
			ValueOperations<Serializable, Object> operations = redisTemplate
					.opsForValue();
			operations.increment(key, cnt);
			result = true;
		} catch (Exception e) {
			e.printStackTrace();
		}
	 ...
	 * @return
	 */
	public boolean addSet(final String key, Object values) {
		boolean result = false;
		try {
